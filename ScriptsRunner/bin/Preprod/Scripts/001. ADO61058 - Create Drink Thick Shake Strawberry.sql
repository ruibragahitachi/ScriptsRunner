...
/*
	*** File name ***
	ADO61058 - Create Drink Thick Shake Strawberry
	*** Description ***
	Add New Drink Thick Shake Strawberry
	...
	*** History ***
	...
	1.0			Hugo Zacarias		2021-07-09			Initial Version	
*/
USE eCommMgr
GO
SET NOCOUNT ON
...
BEGIN TRY
	...
	*/
	...
	DECLARE @FixedProductId INT					= 1687 -- Next Product ID available (it was requested that it needs to be fixed going forward)
		
	DECLARE @MenuCode VARCHAR(50)				= 'TSST3'
	DECLARE @Name VARCHAR(50) 					= 'Thick Shake Strawberry' 
	DECLARE @Description VARCHAR(300)			= 'Ice cold strawberry flavoured Thickshake made from  deliciously smooth ice cream. Serves 1 -  396kcals / serving' 
	DECLARE @ImageURL VARCHAR(50)				= '2107-DRI-Thick-Shake-Strawberry.jpeg'
	...
	DECLARE @SideDisplayOrder INT				= 2

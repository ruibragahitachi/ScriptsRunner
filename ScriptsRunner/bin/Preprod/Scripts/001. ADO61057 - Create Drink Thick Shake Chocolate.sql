...
/*
	*** File name ***
	ADO61057 - Create Drink Thick Shake Chocolate
	*** Description ***
	Add New Drink Thick Shake Chocolate
...
BEGIN TRY
	...
	*/
	...
	DECLARE @FixedProductId INT					= 1686 -- Next Product ID available (it was requested that it needs to be fixed going forward)
		
	DECLARE @MenuCode VARCHAR(50)				= 'TSCH3'
	DECLARE @Name VARCHAR(50) 					= 'Thick Shake Chocolate' 
	DECLARE @Description VARCHAR(300)			= 'Ice cold chocolate flavoured Thickshake made from deliciously smooth ice cream. Serves 1 -  417kcals / serving' 
	DECLARE @ImageURL VARCHAR(50)				= '2107-DRI-Thick-Shake-Chocolate.jpeg'
	...
	DECLARE @SideDisplayOrder INT				= 3
